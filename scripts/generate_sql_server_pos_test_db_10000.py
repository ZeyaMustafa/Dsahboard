...
OUTPUT = Path("data/sql_server_pos_test_10000.sql")
...
LineProducts AS (
    SELECT
        ...
        CASE
            WHEN n % 12 IN (0, 1) THEN N'P004'
            WHEN n % 12 IN (2, 3) THEN N'P006'
            WHEN n % 12 = 4 THEN N'P003'
            WHEN n % 12 = 5 THEN N'P005'
            WHEN n % 12 = 6 THEN N'P009'
            WHEN n % 12 = 7 THEN N'P010'
            WHEN n % 24 = 8 THEN N'P007'
            WHEN n % 24 = 9 THEN N'P008'
            WHEN n % 24 = 10 THEN N'P015'
            WHEN n % 24 = 11 THEN N'P016'
            WHEN n % 24 = 12 THEN N'P011'
            WHEN n % 24 = 13 THEN N'P012'
            WHEN n % 24 = 14 THEN N'P021'
            WHEN n % 24 = 15 THEN N'P022'
            ELSE CONCAT(N'P', RIGHT(CONCAT(N'000', ((n * 7) % 24) + 1), 3))
        END AS ProductCode,
        ((n * 3) % 4) + 1 AS Quantity,
